            ...
            <tr>
                <td>
                    <table style="width: 100%; padding: 10px;">
                        ...
                        <tr>
                            <td>
                                <h3 style="font-weight: normal;">Si deseas cambiar tu contaseña. Presiona sobre el boton
                                    de abajo</h3>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <a href="{{ $url }}" id="active-account"
                                    style="background-color: #00003a;  color: #ffffff; border-radius: 20px; text-align: center; border: 0; padding: 10px 20px;display: block; margin: auto;">Recuperar
                                    contraseña ahora</a>
                            </td>
                        </tr>
                        <tr>
